...
const Payments = () => {
    ...
    const [status1, setStatus1] = useState(""); // verifying, success, failed
...
console.log("paymentlinkdata",paymentlinkdata['transaction_id']);
                ...
                setStatus1(res.data.data.data.transaction_status)
                ...
                if (res.data.data1.data.transaction_status === "success") {
                    isVerified = true;
                    const paymentData = {
                        orderId: res.data.id||paymentlinkdata['transaction_id'],
